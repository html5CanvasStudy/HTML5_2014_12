...
//				rtpPacket.printheader();
	...
	private int parseRTSPrequest() {
		...
		try {
			...
			if (requestTypeString.compareTo("SETUP") == 0) requestType = SETUP;
			else if (requestTypeString.compareTo("PLAY") == 0) requestType = PLAY;
			else if (requestTypeString.compareTo("PAUSE") == 0) requestType = PAUSE;
			else if (requestTypeString.compareTo("TEARDOWN") == 0) requestType = TEARDOWN;
